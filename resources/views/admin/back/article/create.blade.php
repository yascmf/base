                ...
                <div class="tab-pane active" id="tab_1">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" autocomplete="off"
                               value="{{ old('title') }}" placeholder="标题" maxlength="80">
                    </div>
                    <div class="form-group">
                        <label>网址缩略名(slug)
                            <small class="text-red">*</small>
                            <span class="text-green">[a-z0-9\-_]{1,120}</span>
                            <a href="javascript:void(0);" class="auto-to-pinyin"><i class="fa fa-fw fa-hand-o-down"
                                                                                    title="自动转换"></i></a></label>
                        <div class="input-group mono url_slug">
                            <p>//example.org/{category}/
                                <input type="text" id="slug" name="slug" autocomplete="off" value="{{ old('slug') }}"
                                       class="slug" maxlength="120" pattern="[a-z0-9_-]{1,120}"/>.html
                            </p>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>缩略图
                            ...
                            <a href="javascript:void(0);" class="previewPic" data-id="thumb">
                                <i class="fa fa-fw fa-eye" title="预览小图"></i></a>
                        </label>
                    ...
                    <div class="form-group">
                        ...
                        <div id="mdeditor">
                            <textarea class="form-control" name="content"
                                      style="display:none;">{{ old('content', '> hello editor.md') }}</textarea>
                        </div>
                    </div>
                </div><!-- /.tab-pane -->
