...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserImageUploadUrl = "/lib/ckeditor/plugins/imgupload/imgupload.php";
	config.filebrowserBrowseUrl = "/lib/ckeditor/plugins/imgbrowse/imgbrowse.html?imgroot=/uploads/images/";
